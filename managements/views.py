...
def rent(request):
        if request.method == 'POST':
                ...
                if rent_form.is_valid()  :
                        ...
                        # email.send()
                        sendmail(rent_student.email, mail_title, html_message)
...
# gmail api receivecode
def receivecode(request):
        return render(request, 'managements/receivecode.html')
...
def sendmail(to, subject, message_text_html, attachment=None): 
        # Your access code 
        access_token = 'ya29.a0AfH6SMDa5bjmbrDipgfCrffpLkCUDl2gjlePejn7eAQ9b0elT2dVhhXfllhXuYL4b1I7oTUgRWs1_mvUiYCobm9wJm8Va0pD67Hom9xaqWtbN34cTQtTswN1z_GUwQ7ONm0TTiYGCJUe2OwSFlzCvcOnW0YH' 
        user_id = 'chldlswl1212@gmail.com'
        
        URL = 'https://www.googleapis.com/gmail/v1/users/' + user_id + '/messages/send' 
        request_header = { "Content-Type": "application/json", "Authorization": "Bearer " + access_token, "X-GFE-SSL": "yes" } 
        ...
        if __name__ == "__main__":
                sendmail('vnavna16@naver.com', 'subject_test', 'message_test', None)
